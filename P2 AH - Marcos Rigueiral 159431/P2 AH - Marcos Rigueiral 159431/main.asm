...
; link do video no Youtube: https://youtu.be/V5vblk2JbfM
...
DIV3216:
        ...
        CLR REM3					
        CLR REM4					
LOOP:   ROL res1					;Rotate left - passando a resposta uma casa para a esquerda
        ROL res2					
        ROL res3					
        ROL res4          
...
addr18:
	inc r18
	breq disparar			;Branch if Equal - timeout
